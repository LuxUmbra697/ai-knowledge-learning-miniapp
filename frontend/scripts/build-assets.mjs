...
const names = ['book-open','house','library','messages-square','calendar-check','chart-no-axes-combined','user-round','settings-2','arrow-up-right','upload','x','log-out','check','rotate-cw','clock-3','sparkles']
