...
from app.services import grounded_answer_service, retrieval_service, report_service
...
def handlers():
    return {'index': index_document, 'answer': answer_question, 'retrieve': retrieve_evidence, 'report': report_service.run_report_task}
